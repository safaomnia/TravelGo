      ...
      <?php foreach ($voitures as $voiture): ?>
        <div class="swiper-slide">
          <a data-toggle="gallery-top" title="Our street">
            <img src="images/cars/<?=$voiture->photo?>" alt="Our street" class="img-fluid">
          </a>
        </div>
      <?php endforeach ?>
    ...
    <div class="row" style="margin-left:20px;"> 
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 ">
        <ul class="nav nav-tabs tab-line">
          ...
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#tab-de-2"> voiture </a> </li>
        </ul>
        <div class="tab-content">
          <div class="tab-pane booking-search show active" id="tab-de-1">
            <div class="text-block NopaddingDetails">
              <h5 class="mb-4"><?=$agence->nom?></h5>
              <p class="text-muted font-weight-light"><?=$agence->libelle?></p>
            </div>
          </div>
              ...
              <div class="row gallery ml-n1 mr-n1">
                <?php foreach ($voitures as $voiture): ?>
                  <div class="col-lg-4 col-6 px-1 mb-2">
                      <a href="#"><img src="images/cars/<?=$voiture->photo?>" alt="..." class="img-fluid"></a>
                  </div>
                <?php endforeach ?>
              </div>
            </div>
